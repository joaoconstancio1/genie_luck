...
final List<SliderItem> sliderItems = [
  SliderItem(index: 0, title: 'Title 1', color: Colors.red, minRange: 1, maxRange: 100),
  SliderItem(index: 1, title: 'Title 2', color: Colors.blue, minRange: 101, maxRange: 200),
  SliderItem(index: 2, title: 'Title 3', color: Colors.green, minRange: 201, maxRange: 300),
  SliderItem(index: 3, title: 'Title 4', color: Colors.orange, minRange: 301, maxRange: 400),
  SliderItem(index: 4, title: 'Title 5', color: Colors.purple, minRange: 401, maxRange: 500),
  SliderItem(index: 5, title: 'Title 6', color: Colors.yellow, minRange: 501, maxRange: 600),
  SliderItem(index: 6, title: 'Title 7', color: Colors.pink, minRange: 601, maxRange: 700),
  SliderItem(index: 7, title: 'Title 8', color: Colors.teal, minRange: 701, maxRange: 800),
  SliderItem(index: 8, title: 'Title 9', color: Colors.cyan, minRange: 801, maxRange: 900),
  SliderItem(index: 9, title: 'Title 10', color: Colors.brown, minRange: 901, maxRange: 1000),
];
                    ...
                    onPressed: () async {
                      setState(() {
                        ...
                        selectedItem = sliderItems.firstWhere(
                          (item) => randomNumber! >= item.minRange! && randomNumber! <= item.maxRange!,
